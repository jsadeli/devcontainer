...
curl "https://raw.githubusercontent.com/jsadeli/dotfiles/refs/heads/main/.devcontainer/dotfiles/.p10k.zsh" -o "$HOME/.p10k.zsh"

echo -e "${YELLOW}Copy zsh config...${OFF}"
curl "https://raw.githubusercontent.com/jsadeli/dotfiles/refs/heads/main/.devcontainer/dotfiles/.zshrc" -o "$HOME/.zshrc"
